	...
	<div class="main">
		...
		<div class="manage">
			<table class="list">
				...
				<c:forEach items="${easyBuyProductList}" var="ebpc">
					<tr>
						<td class="first w4 c">${ebpc.epcId.epcId}</td>
						<td class="thumb"><img src="${ebpc.epFileName}" /><a href="product-view.jsp" target="_blank">${ebpc.epNam}</a></td>
