...
<div id="main" class="wrap">
	<div class="lefter">
		...
		<div class="last-view" style="height: 350px">
			<h2>最近浏览</h2>
			<c:forEach items="${browseList}" var="bb" begin="0" end="2">
				<dl class="clearfix" style="width: 200px">
					<dt><img src="${bb.imgAddress}" /></dt>
					<dd style="margin-bottom: 40px"><a href="#" style="margin: 45px">${bb.browseName}</a></dd>
				</dl>
			</c:forEach>
			<%--<dl class="clearfix">
	...
	<div class="main">
		<div class="product-list">
			...
			<ul class="product clearfix">
				<c:forEach items="${list}" var="ebp">
					<li>
						<dl>
							<dt><img src="${ebp.epFileName}" /></dt>
							<dd class="title"><a href="<%=request.getContextPath()%>/EasyBuyProductCategoryServlet?eId=${ebp.epId}&&method=browse" target="_blank">${ebp.epNam}</a></dd>
							<dd class="price">￥${ebp.epPrice}</dd>
						</dl>
					</li>
				</c:forEach>
