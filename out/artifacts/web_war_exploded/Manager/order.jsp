...
<script type="text/javascript" src="scripts/function-manage.jsp"></script>
</head>
<body>
...
<div id="main" class="wrap">
	...
	<div class="main">
		...
		<div class="manage">
			<div class="search">
				<form method="post" action="<%=request.getContextPath()%>/BackstageProductServlet?method=order">
			...
			<table class="list">
				...
				<c:forEach items="${easyBuyOrderList}" var="ord">
					<tr>
						<td class="first w4 c">${ord.eo_id}</td>
						<td class="w1 c">${ord.eo_user_name}</td>
						<td>${ord.eo_user_address}</td>
						<td class="w1 c">发货</td>
